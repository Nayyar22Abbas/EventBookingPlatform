  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      >
        ...
        >
          <h1 className="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#bfa544] to-[#ffd700]">🏘️ Owner Panel</h1>
        </motion.div>
        <motion.nav
          className="space-y-3"
          ...
          >
            ...
            >
              <motion.div
                ...
                transition={{ delay: 0.1 }}
              >
                <h1 className="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#bfa544] to-[#ffd700]">🏘️ Owner</h1>
              </motion.div>
              <motion.nav
                className="space-y-2"
      ...
      <div className="flex-1 flex flex-col">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-xl font-bold text-white hidden sm:block">🏘️ Hall Owner Dashboard</h2>
          </div>
        </motion.header>
