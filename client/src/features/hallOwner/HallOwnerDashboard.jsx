      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-extrabold text-white mb-3">
            Hall <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#bfa544] to-[#ffd700]">Owner Dashboard</span>
          </h1>
          <p className="text-xl text-gray-300">Manage your halls, bookings, and offerings</p>
        </motion.div>
